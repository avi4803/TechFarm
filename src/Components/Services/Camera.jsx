...
<div className="flex flex-row flex-rows-2 gap-16">
   ...
   <div className="bg-black w-full md:w-[45%] flex flex-col lg:justify-center h-auto  bg-gray-400 lg:ml-0 rounded-lg overflow-hidden items-center ">
